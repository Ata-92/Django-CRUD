...
from fscohort.views import HomeView, StudentAdd, StudentDelete, StudentDetail, StudentList, StudentUpdate, home_page, student_add, student_delete, student_detail, student_list, student_update
