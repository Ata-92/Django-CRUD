...
from fscohort.views import HomeView, StudentAdd, StudentDetail, StudentList, home_page, student_add, student_delete, student_detail, student_list, student_update
